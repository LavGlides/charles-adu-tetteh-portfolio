          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="text-sm text-gray-600 ml-4 mt-1">
                <li>
                  • Title: Charles Adu Tetteh - Full-Stack Developer & AWS Cloud
                  Expert
                </li>
          ...
          <div className="space-y-3 text-sm">
            <div>
              ...
              <p className="text-gray-600">
                Share your portfolio URL in a chat to see the preview with your
            ...
            <div>
              ...
              <p className="text-gray-600">
                Post your URL on Facebook or Instagram to see the Open Graph
                preview.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Tweet your URL to see the Twitter Card with your image.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Share your URL in a LinkedIn post to see the professional
                preview.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Check your browser tab for the favicon, bookmark your site to
                see the icon, and add to home screen on mobile.
              </p>
            </div>
          </div>
        </div>
