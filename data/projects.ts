...
export const projects: Project[] = [
  {
    ...
    description:
      "Full-stack web application for managing GBC's assets across 31 transmitter sites and 7 TV channels",
    image: "/gbcasset.png",
    technologies: [
      "React",
      "Next.js",
    ...
    status: "live",
    motivation:
      "Need for efficient asset tracking and maintenance management at Ghana Broadcasting Corporation",
    problem:
  ...
  },
  {
    ...
    title: "GBC Palm",
    description:
      "React Native mobile app for streaming GBC's TV channels with AWS CloudFront integration",
    image: "/gbcpalm.png",
    technologies: [
      "React Native",
      "AWS CloudFront",
    ...
    status: "live",
    motivation:
      "Increasing demand for mobile streaming of local Ghanaian content",
    problem:
  ...
  },
  {
    ...
    title: "Market Ghana",
    description:
      "Full-stack marketplace platform for Ghanaian shops with integrated payment systems",
    ...
    status: "development",
    motivation:
      "Supporting local Ghanaian businesses to establish online presence",
    problem:
